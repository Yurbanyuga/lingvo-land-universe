      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Онлайн школа английского языка для эффективного и интересного обучения в любом возрасте.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">Информация</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/advantages" className="text-muted-foreground hover:text-primary transition-colors">
                  Преимущества
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/start-free" className="text-muted-foreground hover:text-primary transition-colors">
                  Бесплатное начало
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-foreground/10 mt-8 pt-8">
          <p className="text-sm text-muted-foreground text-center">
            © {currentYear} Lingvo Land. Все права защищены.
          </p>
        </div>
      </div>
    </footer>
